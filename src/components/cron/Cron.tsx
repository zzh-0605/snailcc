...
import { CronProps, PeriodType, SetValuePeriod } from "./types";
  ...
  const clearButtonNode = useMemo(
    () => {
      if (clearButton && !readOnly) {
        return (
          <Button variant="contained" disabled={disabled} onClick={handleClear}>
  ...
  return (
    <Stack direction="row" spacing={2}>
      <Period
        ...
        setValue={setPeriod as SetValuePeriod}
        locale={locale}
        className={className}
        disabled={disabled}
        readOnly={readOnly}
